    ...
    >
      {!file ? (
        <div className="flex flex-col items-center gap-3">
          <div className={`w-14 h-14 rounded-xl flex items-center justify-center transition-all ${dragOver ? 'bg-teal-500/20 scale-110' : 'bg-gray-100'}`}>
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={onCancel}
              className="px-4 py-2 text-xs font-medium text-gray-500 hover:text-gray-700 transition-all"
            >
              Cancel
            </button>
          </div>
        ...
        <div className="flex flex-col items-center justify-center gap-2 py-6">
          <div className="flex items-center justify-center gap-3 py-4">
            ...
            <span className="text-sm text-gray-500">
              Processing <strong className="text-gray-700">{file.name}</strong>...
            </span>
